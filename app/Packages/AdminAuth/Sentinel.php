...
use App\Packages\AdminAuth\Interfaces\Persistences\PersistenceRepositoryInterface;
...
use App\Packages\AdminAuth\Interfaces\ThrottleRepositoryInterface;
...
use App\Packages\AdminAuth\Checkpoints\CheckpointInterface;
...
class Sentinel
{
     ...
     *
     * @var \App\Packages\AdminAuth\Interfaces\Persistences\PersistenceRepositoryInterface
     */
     ...
     * The Role repository.
     *
     * @var \App\Packages\AdminAuth\Interfaces\Roles\RoleRepositoryInterface
     */
    protected $roles;
     ...
     *
     * @var \App\Packages\AdminAuth\Interfaces\ReminderRepositoryInterface
     */
    protected $reminders;
     ...
     *
     * @var \App\Packages\AdminAuth\Interfaces\ThrottleRepositoryInterface
     */
    protected $throttle;
     ...
     *
     * @param  \App\Packages\AdminAuth\Interfaces\Persistences\PersistenceRepositoryInterface  $persistence
     * @param  \App\Packages\AdminAuth\Interfaces\Users\UserRepositoryInterface  $users
     * @param  \App\Packages\AdminAuth\Interfaces\Roles\RoleRepositoryInterface  $roles
    ...
    public function __construct(
        ...
        ThrottleRepositoryInterface $throttle,
     ...
     * @return \App\Packages\AdminAuth\Interfaces\Users\UserInteface|bool
     ...
     *
     * @param  \App\Packages\AdminAuth\Interfaces\Users\UserInterface|array  $credentials
     * @param  bool  $remember
     * @param  bool  $login
     * @return \App\Packages\AdminAuth\Interfaces\Users\UserInterface|bool
     */
     ...
     *
     * @return \App\Packages\AdminAuth\Interfaces\Users\UserRepositoryInterface
     */
     ...
     *
     * @return \App\Packages\AdminAuth\Interfaces\Roles\RoleRepositoryInterface
     */
     ...
     *
     * @return \App\Packages\AdminAuth\Interfaces\Persistences\PersistenceRepositoryInterface
     */
     ...
     *
     * @param  \App\Packages\AdminAuth\Interfaces\Persistences\PersistenceRepositoryInterface  $persistences
     * @return void
     */
     ...
     *
     * @return \App\Packages\AdminAuth\Interfaces\Activations\ActivationRepositoryInterface
     */
     ...
     *
     * @return \App\Packages\AdminAuth\Interfaces\ReminderRepositoryInterface
     */
     ...
     *
     * @param  \App\Packages\AdminAuth\Interfaces\ReminderRepositoryInterface  $reminders
     * @return void
     */
     ...
     *
     * @return \App\Packages\AdminAuth\Interfaces\ThrottleRepositoryInterface
     */
     ...
     *
     * @param  \App\Packages\AdminAuth\Interfaces\ThrottleRepositoryInterface  $throttle
     * @return void
     */
    ...
    {
        return $this->getThrottleRepository()->removeUserThrottle($userId);
    }

    public function countUserThrottle($userId)
    {
        return $this->getThrottleRepository()->countUserThrottle($userId);
    }
}
